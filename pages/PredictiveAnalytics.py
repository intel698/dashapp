...
g11 = create_results_graph(df1, 'End_Count')

df2 = cust_detail.groupby('hotspot')[per_list_g2].sum()
g2 = create_byplan_graph(df2)

df3 = cust_detail[cust_detail[per_currQ]!=0].groupby(['hotspot'
...
g4 = create_compare_graph(df4)

g5 = create_month_add_graph(df, 'Jun', 1200)
